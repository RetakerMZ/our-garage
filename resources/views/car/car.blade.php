          ...
          <div class="col-lg-2 col-md-4 col-4 car__">
            <div class="category-car">
              <div class="categoryimg">
                <a href="{{route('car.car.index', $tipe->tipe_mobil)}}"><img src="{{asset('storage/images/tipe_mobils/'.$tipe->gambar)}}" alt=""></a>
                <p>{{$tipe->tipe_mobil}}</p>
              </div>
            </div>
          </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="item text-center">
                                <div class="car-wrap rounded ftco-animate mx-auto ">
                                    ...
                                    <div class="text">
                                        <h2 class="mb-0 text__"><a href="#">Honda Hrv</a></h2>
                            ...
                            <div class="item text-center">
                                ...
                                <div class="img rounded d-flex align-items-center mx-auto" style="background-image: url('images/agya.jpg'); height: 200px; ">
                                    ...
                                    <div class="text">
                                        <h2 class="mb-0"><a href="#">Toyota Agya</a></h2>
                                        <div class="d-flex mb-3">
                                            <!-- <span>Lorem ipsum dolor sit amet</span> -->
                                        </div>
                                        <div class="mx-auto">
