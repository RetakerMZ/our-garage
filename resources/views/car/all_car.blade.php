    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-6 align-item-center text-center">
        ...
        @endif
          ...
          <a href="https://api.whatsapp.com/send?phone=6285829261962&text=Halo,%20Kakak%20saya%20ingin%20menyewa%20{{ $allcar->nama }} {{ $allcar->transmition }} seharga Rp.{{number_format($allcar->harga,0,",",".")}}K per hari, saya menyewa selama ... hari" class="btn btn-primary btncar">Order now</a>
