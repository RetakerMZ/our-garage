<footer class="ftco-footer ftco-bg-dark pt-5">
        <div class="container" id="contact">
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul>
                        <li><span>OURGARAGE.ID</span></li>
                        <li><span class="icon icon-map-marker"></span><span class="text">Jl. Nangka Selatan No. 168 Denpasar - Bali</span></li>
                    </ul>
                    </div>
                </div>
            </div>
