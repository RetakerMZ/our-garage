...
@section('content')
<!-- Jumbotron -->
<div class="jumbotron jumbotron-fluid jumbot__" style="background-image: url('images/motor1.jpg');background-size: 100%; margin-top: 50px;">
  <div class="container">
  ...
  <div class="container pb-5">
    <div class="row pt-3">
        ...
        <div class="row ">
          ...
          <div class="col-lg-3 col-md-4 col-3 car__">
